...
interface ICarColorString{
    color:string;
    getColor():string;
}

interface ICarro extends ICarString, ICarColorString{
    power:number;
    getPower():number;
}
...
var Sedan = new Carro("Sedan", "Black", 90);
console.log(Sedan.getCar());
...
var cores = new Array(["red", "blue", "orange"]);
cores['title'] = "Colores";
console.log(cores);
